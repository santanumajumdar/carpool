...
//  Hide Element
  ...
  //  Create DOM Elements
      if( (options.enableDropdown) && options.dropdownSource() != null ) {
        ...
        var $tag_input_elem = (options.readonly) ? '' : jQuery('<input type="text" class="row padding10 row59 '+options.className+'-input" value="" id="welcome" placeholder="your passing through point (address,city,station...)"/>');
      }
