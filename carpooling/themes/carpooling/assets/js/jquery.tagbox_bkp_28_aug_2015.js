...
//  Hide Element
  ...
  //  Create DOM Elements
      if( (options.enableDropdown) && options.dropdownSource() != null ) {
        ...
        var $tag_input_elem = (options.readonly) ? '' : jQuery('<input type="text" class="row padding10 row59 '+options.className+'-input" value="" id="welcome" placeholder="your arrival point (address,city,station...)"/>');
      }
      ...
      var $tag_list_elem = jQuery('<div class="row margintop20"><span class="'+options.className+'-list" id="'+options.className+'-list-'+uuid+'"></span>');
