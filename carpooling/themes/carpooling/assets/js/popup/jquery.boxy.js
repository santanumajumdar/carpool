...
jQuery.extend(Boxy, {
    ...
    WRAPPER:    "<table cellspacing='0' cellpadding='0' border='0' class='boxy-wrapper'>" +
                "<tr><td class='boxy-top' colspan='3'></td></tr>" +
                "<tr><td class='boxy-left'></td><td class='boxy-inner'></td><td class='boxy-right'></td></tr>" +
                "<tr><td class='boxy-bottom' colspan='3'></td></tr>" +
                "</table>",
    ...
    ask: function(question, answers, callback, options) {
        ...
        buttons.html(jQuery.map(Boxy._values(answers), function(v) {
			...
			if(v == 'OK'){
            	return "<input type='button' class='ok' value='" + v + "' />";
			}
			else if(v == 'Cancel'){
				return "<input type='button' class='cancel' value='" + v + "' />";
			}
        }).join(' '));
