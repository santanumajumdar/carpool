  ...
  <div class="container">
    <div class="row footer">
        		...
        		<div class="col-lg-4 col-md-6 col-sm-6  col-xs-12 log-subs fleft">
			      <div class="logo"> <a href="index.html"> <img src="<?php echo theme_img('logo.png')?>"> </a> </div>
      ...
      <ul class="fleft ftr-ste">
        ...
        <li> <a href="#"> <?php echo lang('company_directory');?> </a> </li>
        <li> <a href="#"> <?php echo lang('contact');?> </a> </li>
        <li> <a href="#"> <?php echo lang('find_a_candidate');?>  </a> </li>
        <li> <a href="#"> <?php echo lang('find_a_car');?> </a> </li>       
      </ul>
    </div>
    ...
    <div class="row footer colorwhite">
      ...
      <div class="fright">
        <ul class="fleft soc-ico">
            <li> <a href="#"> <img src="<?php echo theme_img('fb-ico.png')?>"> </a> </li>
            <li> <a href="#"> <img src="<?php echo theme_img('tw-ico.png')?>"> </a> </li>
            <li> <a href="#"> <img src="<?php echo theme_img('gp-ico.png')?>"> </a> </li>
            <li> <a href="#"> <img src="<?php echo theme_img('in-ico.png')?>"> </a> </li>
            <li> <a href="#"> <img src="<?php echo theme_img('pin-ico.png')?>"> </a> </li>
            <li> <a href="#"> <img src="<?php echo theme_img('vi-ico.png')?>"> </a> </li>
        </ul>
      </div>
    </div>
  </div>
