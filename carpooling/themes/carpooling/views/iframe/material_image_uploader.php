...
<?php if($file_name):?>
	parent.add_material_image('<?php echo $file_name;?>');
<?php endif;?>
...
<div class="row-fluid">
	<div class="span12">
		<?php echo form_open_multipart($this->config->item('admin_folder').'/materials/material_image_upload', 'class="form-inline"');?>
