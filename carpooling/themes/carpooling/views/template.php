                ...
                <table bgcolor="#ffffff" text="#ffffff" width="100%" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    ...
                    <td width="280" valign="top" class="hide">
                      ...
                      <a href="http://www.carpoolingscript.com" style="text-align:right; float: left; margin: 20px 0 0 20px;"><img src="http://www.carpoolingscript.com/demo/carpooling/themes/carpooling/assets/img/logo-template.jpg" width="188" height="59" border="0" alt="carpoolingscript Logo" /></a>
                    </td>
                    <!-- /header right -->
                  </tr>
                </table>
