  ...
  <div class="row">
    ...
    <div class="container-fluid">
      ...
      <div class="fleft width100 margin">
        ...
        <!-- <a id="a_tab" class="b_t_1" onclick="tab_tab(this, 'p_block_bottom'), height_right()">Booked Trips</a>
         <a id="a_tab" class="b_t_1" onclick="tab_tab(this, 'p_block_bottom'), height_right()">Ratings</a>-->
